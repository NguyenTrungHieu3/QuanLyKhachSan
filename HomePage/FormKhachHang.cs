...
namespace HomePage
{
	public partial class frm_KhachHang : Form
	{
		...
		private void btn_Them_Click(object sender, EventArgs e)
		{
			...
			{
				// Modified MessageBox with icon and buttons
		...
		private void btn_Sua_Click(object sender, EventArgs e)
		{
			...
			try
			{
				...
				{
					MessageBox.Show("Lỗi sửa khách hàng", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
				}
				LoadKhachHang();
				ClearForm();
			}
		...
		private void btn_Xoa_Click(object sender, EventArgs e)
		{
			try
			{
				...
				{
					MessageBox.Show("Lỗi xóa khách hàng", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
				}
				LoadKhachHang();
				ClearForm();
			}
